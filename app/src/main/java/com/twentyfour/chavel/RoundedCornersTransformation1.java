...
public class RoundedCornersTransformation1 implements Transformation<Bitmap> {
    ...
    public RoundedCornersTransformation1(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public RoundedCornersTransformation1(Context context, int radius, int margin, String color, int border) {
        this(context, radius, margin, CornerType.BORDER);
        mColor = color;
        mBorder = border;
    }

    public RoundedCornersTransformation1(BitmapPool pool, int radius, int margin) {
