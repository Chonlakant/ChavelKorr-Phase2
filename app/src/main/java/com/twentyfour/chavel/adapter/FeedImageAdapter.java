<<<<<<< HEAD:app/src/main/java/com/twentyfour/chavel/adapter/ImageFeedHomeAdapter.java
...
public class FeedImageAdapter extends RecyclerView.Adapter<FeedImageAdapter.ViewHolder> {
    ...
    public FeedImageAdapter(Context ctx, List<String> list) {
        this.ctx = ctx;
        this.list = list;
    ...
    @Override
    public FeedImageAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_image_feed_home, parent, false);
        ViewHolder vh = new ViewHolder(v);
        return vh;
    }
...
>>>>>>> korrio/master:app/src/main/java/com/twentyfour/chavel/adapter/FeedImageAdapter.java
}